...
public class MessageViewController: SLKTextViewController {
    ...
    override public class func tableViewStyle(for decoder: NSCoder) -> UITableViewStyle {
...
extension MessageViewController {
    ...
    func configureDataSource() {
        ...
        for _ in 0..<100 {
            ...
            chatmessage.username = LoremIpsum.name()
            chatmessage.text = LoremIpsum.words(withNumber: words)
            array.append([chatmessage])
        }
        var reversed = array.reversed()
        //self.messages.append(reversed.first)
...
extension MessageViewController {
    ...
    override public func ignoreTextInputbarAdjustment() -> Bool {
        return super.ignoreTextInputbarAdjustment()
    }
    
    override public func forceTextInputbarAdjustment(for responder: UIResponder!) -> Bool {
    ...
    override public func didChangeKeyboardStatus(_ status: SLKKeyboardStatus) {
        switch status {
        case .willShow:
            print("Will Show")
        case .didShow:
    ...
    override public func textDidUpdate(_ animated: Bool) {
    ...
    override public func didPressArrowKey(_ keyCommand: UIKeyCommand?) {
    ...
    override public func keyForTextCaching() -> String? {
        
        return Bundle.main.bundleIdentifier
    }
    
    // Notifies the view controller when the user has pasted a media (image, video, etc) inside of the text view.
    override public func didPasteMediaContent(_ userInfo: [AnyHashable: Any]) {
    ...
    override public func willRequestUndo() {
    ...
    override public func canShowTypingIndicator() -> Bool {
    ...
    override public func shouldProcessText(forAutoCompletion text: String) -> Bool {
        return true
    }
...
extension MessageViewController {
    ...
    override public func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
        return true
    }
    
    override public func textViewShouldEndEditing(_ textView: UITextView) -> Bool {
        // Since SLKTextViewController uses UIScrollViewDelegate to update a few things, it is important that if you override this method, to call super.
        return true
    }
    
    override public func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        
        return super.textView(textView, shouldChangeTextIn: range, replacementText: text)
    }
    
    override public func textView(_ textView: SLKTextView, shouldOfferFormattingForSymbol symbol: String) -> Bool {
    ...
    override public func textView(_ textView: SLKTextView, shouldInsertSuffixForFormattingWithSymbol symbol: String, prefixRange: NSRange) -> Bool {
